...
//    NSArray *myArray = @[@"ca-app-pub-5975067574870435/1046981769"];
...
bool UPsIronSource_iOS::HasRewardedVideo() const
{
    ...
    UE_LOG(LogPsIronSource, Log, TEXT("TELETABILER GELDI!!!!!!!!!!!!!!!!!!!!!!!!!!!"));
    UE_LOG(LogPsIronSource, Log, TEXT("%d"), [IronSource hasRewardedVideo]);

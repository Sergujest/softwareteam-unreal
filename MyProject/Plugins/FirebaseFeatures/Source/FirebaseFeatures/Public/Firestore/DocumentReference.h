...
public:
     ...
     * library.
     */
	UFUNCTION(BlueprintCallable, Category = "Firebase|Firestore|DocumentReference")
	void AddSnapshotListener(UPARAM(DisplayName = "Listener") FDocumentSnapshotListener Callback);

#if WITH_FIREBASE_FIRESTORE 
	FORCEINLINE operator firebase::firestore::DocumentReference()
	{
		return Reference;
	}

private:
	firebase::firestore::DocumentReference Reference;
#endif // WITH_FIREBASE_FIRESTORE 
};

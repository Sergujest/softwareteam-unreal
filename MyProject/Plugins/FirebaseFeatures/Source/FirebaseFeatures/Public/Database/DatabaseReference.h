...
private:
	...
	FMutableData(const firebase::database::MutableData& InMutable);
...
private:
	TUniquePtr<firebase::database::MutableData> Mutable;
};
...
protected:
	...
	class FValueListener* ValueListener;
	class FChildListener* ChildListener;

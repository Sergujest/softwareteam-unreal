...
DECLARE_DELEGATE(FRemoteConfigCallback);
...
public:
	...
	/// activated.
	UFUNCTION(BlueprintCallable, Category = "Firebase|RemoteConfig")
	static UPARAM(DisplayName = "Activated")  bool ActivateFetched();

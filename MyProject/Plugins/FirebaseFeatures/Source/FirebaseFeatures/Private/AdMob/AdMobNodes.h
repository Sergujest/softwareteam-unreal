...
#include "AdMobNodes.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FDynMultAdMobCallback, const EAdMobError, Error);
...
private:
	void OnActionOver(const EAdMobError Error);
};
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FDynMultCreateBanner, UBannerView*, BannerView, const EAdMobError, Error);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FDynMultCreateInterstitial, UInterstitialAd*, InterstitialAd, const EAdMobError, Error);
